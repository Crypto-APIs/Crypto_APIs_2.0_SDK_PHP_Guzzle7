...
**senders** | [**\CryptoAPIs\Model\GetOmniTransactionDetailsByTransactionIDTxidRISendersInner[]**](GetOmniTransactionDetailsByTransactionIDTxidRISendersInner.md) | Represents an object of addresses that provide the funds. |
