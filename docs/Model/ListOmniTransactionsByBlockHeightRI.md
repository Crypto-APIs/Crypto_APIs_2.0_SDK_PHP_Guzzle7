...
**recipients** | [**\CryptoAPIs\Model\ListOmniTransactionsByBlockHeightRIRecipientsInner[]**](ListOmniTransactionsByBlockHeightRIRecipientsInner.md) | Represents an object of addresses that receive the transactions. |
**senders** | [**\CryptoAPIs\Model\ListOmniTransactionsByBlockHeightRISendersInner[]**](ListOmniTransactionsByBlockHeightRISendersInner.md) | Represents an object of addresses that provide the funds. |
