...
**vin** | [**\CryptoAPIs\Model\GetTransactionDetailsByTransactionIDRIBSDVinInner[]**](GetTransactionDetailsByTransactionIDRIBSDVinInner.md) | Represents the transaction inputs. |
