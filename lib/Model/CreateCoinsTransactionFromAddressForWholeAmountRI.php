...
class CreateCoinsTransactionFromAddressForWholeAmountRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'note' => 'string',
        'recipients' => '\CryptoAPIs\Model\CreateCoinsTransactionFromAddressForWholeAmountRIRecipients[]',
     ...
     * Gets recipients
     *
     * @return \CryptoAPIs\Model\CreateCoinsTransactionFromAddressForWholeAmountRIRecipients[]
     */
     ...
     * Sets recipients
     *
     * @param \CryptoAPIs\Model\CreateCoinsTransactionFromAddressForWholeAmountRIRecipients[] $recipients Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
