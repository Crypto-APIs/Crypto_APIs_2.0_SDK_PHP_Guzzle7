...
/**
 * ListUnconfirmedTransactionsByAddressRIBSD2Vin Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListUnconfirmedTransactionsByAddressRIBSD2Vin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUnconfirmedTransactionsByAddressRIBSD2_vin';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'script_sig' => '\CryptoAPIs\Model\ListConfirmedTransactionsByAddressRIBSD2ScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\ListConfirmedTransactionsByAddressRIBSD2ScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\ListConfirmedTransactionsByAddressRIBSD2ScriptSig $script_sig script_sig
     *
     * @return self
     */
