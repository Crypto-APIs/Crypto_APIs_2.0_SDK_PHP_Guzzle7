...
/**
 * ListUnconfirmedTransactionsByAddressRIBSLVinInner Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListUnconfirmedTransactionsByAddressRIBSLVinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUnconfirmedTransactionsByAddressRIBSL_vin_inner';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'script_sig' => '\CryptoAPIs\Model\ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig $script_sig script_sig
     *
     * @return self
     */
     ...
     * Sets vout
     *
     * @param int|null $vout Defines the vout of the transaction output, i.e. which output to spend.
     *
     * @return self
     */
