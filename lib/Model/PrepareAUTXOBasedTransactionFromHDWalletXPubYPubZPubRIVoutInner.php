...
/**
 * PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVoutInner Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVoutInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareAUTXO_BasedTransactionFromHDWalletXPubYPubZPubRI_vout_inner';
     ...
     * Sets script
     *
     * @param string $script Representation of the script
     *
     * @return self
     */
