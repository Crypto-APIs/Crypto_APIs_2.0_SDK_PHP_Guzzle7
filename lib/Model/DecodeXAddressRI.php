...
/**
 * DecodeXAddressRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class DecodeXAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DecodeX-AddressRI';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['classic_address'] === null) {
            $invalidProperties[] = "'classic_address' can't be null";
        }
     ...
     * Sets address_tag
     *
     * @param int $address_tag Defines a specific Tag that is an additional XRP address feature. It helps identifying a transaction recipient beyond a wallet address.
     *
     * @return self
     */
     ...
     *
     * @param string $classic_address Represents the public address, which is a compressed and shortened form of a public key.
     *
     * @return self
     */
