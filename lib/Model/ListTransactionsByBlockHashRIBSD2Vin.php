...
/**
 * ListTransactionsByBlockHashRIBSD2Vin Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListTransactionsByBlockHashRIBSD2Vin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTransactionsByBlockHashRIBSD2_vin';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'coinbase' => 'string',
        'script_sig' => '\CryptoAPIs\Model\ListTransactionsByBlockHashRIBSD2ScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\ListTransactionsByBlockHashRIBSD2ScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\ListTransactionsByBlockHashRIBSD2ScriptSig $script_sig script_sig
     *
     * @return self
     */
