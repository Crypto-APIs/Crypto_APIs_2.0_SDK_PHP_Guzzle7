...
/**
 * GetBlockDetailsByBlockHeightRIBS Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class GetBlockDetailsByBlockHeightRIBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetBlockDetailsByBlockHeightRIBS';
     ...
     * Sets weight
     *
     * @param int $weight Represents a measurement to compare the size of different transactions to each other in proportion to the block size limi
     *
     * @return self
     */
     ...
     * Sets gas_limit
     *
     * @param int $gas_limit Numeric representation of the block gas_limit
     *
     * @return self
     */
     ...
     * Sets gas_used
     *
     * @param int $gas_used Numeric representation of the block gas_limit
     *
     * @return self
     */
     ...
     * Sets ds_block
     *
     * @param int $ds_block Numeric representation of the ds block
     *
     * @return self
     */
     ...
     * Sets ds_difficulty
     *
     * @param string $ds_difficulty Numeric representation of the ds difficulty
     *
     * @return self
     */
     ...
     * Sets ds_leader
     *
     * @param string $ds_leader String representation of the ds leader
     *
     * @return self
     */
