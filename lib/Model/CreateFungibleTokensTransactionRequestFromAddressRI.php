...
class CreateFungibleTokensTransactionRequestFromAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'note' => 'string',
        'recipients' => '\CryptoAPIs\Model\CreateFungibleTokensTransactionRequestFromAddressRIRecipientsInner[]',
     ...
     * Gets recipients
     *
     * @return \CryptoAPIs\Model\CreateFungibleTokensTransactionRequestFromAddressRIRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \CryptoAPIs\Model\CreateFungibleTokensTransactionRequestFromAddressRIRecipientsInner[] $recipients Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
