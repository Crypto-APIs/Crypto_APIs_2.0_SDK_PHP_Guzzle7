...
/**
 * ListTransactionsByBlockHashRIBSD2VinInner Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListTransactionsByBlockHashRIBSD2VinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTransactionsByBlockHashRIBSD2_vin_inner';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'coinbase' => 'string',
        'script_sig' => '\CryptoAPIs\Model\ListTransactionsByBlockHashRIBSD2VinInnerScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\ListTransactionsByBlockHashRIBSD2VinInnerScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\ListTransactionsByBlockHashRIBSD2VinInnerScriptSig $script_sig script_sig
     *
     * @return self
     */
