...
class CreateCoinsTransactionRequestFromAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'note' => 'string',
        'recipients' => '\CryptoAPIs\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[]',
     ...
     * Gets recipients
     *
     * @return \CryptoAPIs\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \CryptoAPIs\Model\CreateCoinsTransactionRequestFromAddressRIRecipientsInner[] $recipients Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
