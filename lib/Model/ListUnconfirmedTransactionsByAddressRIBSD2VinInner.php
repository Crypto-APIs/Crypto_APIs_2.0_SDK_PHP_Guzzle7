...
/**
 * ListUnconfirmedTransactionsByAddressRIBSD2VinInner Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListUnconfirmedTransactionsByAddressRIBSD2VinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUnconfirmedTransactionsByAddressRIBSD2_vin_inner';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'script_sig' => '\CryptoAPIs\Model\ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig $script_sig script_sig
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value String representation of the amount
     *
     * @return self
     */
