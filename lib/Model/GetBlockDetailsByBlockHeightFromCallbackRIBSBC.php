...
/**
 * GetBlockDetailsByBlockHeightFromCallbackRIBSBC Class Doc Comment
 *
 * @category Class
 ...
 */
class GetBlockDetailsByBlockHeightFromCallbackRIBSBC implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetBlockDetailsByBlockHeightFromCallbackRIBSBC';
     ...
     * Sets bits
     *
     * @param string $bits A sub-unit of BCH equal to 0.000001 BCH, or 100 Satoshi, and is the same as microbitcoincash (μBCH). Bits have two-decimal precision.
     *
     * @return self
     */
