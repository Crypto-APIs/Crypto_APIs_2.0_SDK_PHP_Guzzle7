...
class GetTransactionRequestDetailsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'network' => 'string',
        'recipients' => '\CryptoAPIs\Model\GetTransactionRequestDetailsRIRecipientsInner[]',
     ...
     * Gets recipients
     *
     * @return \CryptoAPIs\Model\GetTransactionRequestDetailsRIRecipientsInner[]
     */
     ...
     * Sets recipients
     *
     * @param \CryptoAPIs\Model\GetTransactionRequestDetailsRIRecipientsInner[] $recipients Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
