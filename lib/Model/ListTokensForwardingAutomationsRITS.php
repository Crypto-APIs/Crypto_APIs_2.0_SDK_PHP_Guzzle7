...
/**
 * ListTokensForwardingAutomationsRITS Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListTokensForwardingAutomationsRITS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTokensForwardingAutomationsRITS';
     ...
     * Sets property_id
     *
     * @param int $property_id Defines the Property ID of the Omni Layer token.
     *
     * @return self
     */
     ...
     *
     * @param string $contract_address Defines the token contract address.
     *
     * @return self
     */
