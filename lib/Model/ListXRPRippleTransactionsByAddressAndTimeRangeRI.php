...
/**
 * ListXRPRippleTransactionsByAddressAndTimeRangeRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListXRPRippleTransactionsByAddressAndTimeRangeRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListXRPRippleTransactionsByAddressAndTimeRangeRI';
     ...
     *
     * @param int|null $destination_tag A destination tag is a value used to discern the holder of the Ripple (XRP) being deposited or withdrawn.
     *
     * @return self
     */
