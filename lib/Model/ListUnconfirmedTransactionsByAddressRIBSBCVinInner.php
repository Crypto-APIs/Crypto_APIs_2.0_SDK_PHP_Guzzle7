...
/**
 * ListUnconfirmedTransactionsByAddressRIBSBCVinInner Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListUnconfirmedTransactionsByAddressRIBSBCVinInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUnconfirmedTransactionsByAddressRIBSBC_vin_inner';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'script_sig' => '\CryptoAPIs\Model\GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\GetTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig $script_sig script_sig
     *
     * @return self
     */
     ...
     * Sets txid
     *
     * @param string $txid String representation of the txid
     *
     * @return self
     */
     ...
     * Sets vout
     *
     * @param int $vout Defines the vout of the transaction output, i.e. which output to spend.
     *
     * @return self
     */
