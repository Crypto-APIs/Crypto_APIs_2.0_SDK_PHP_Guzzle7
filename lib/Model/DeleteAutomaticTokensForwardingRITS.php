...
/**
 * DeleteAutomaticTokensForwardingRITS Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class DeleteAutomaticTokensForwardingRITS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteAutomaticTokensForwardingRITS';
     ...
     * Sets property_id
     *
     * @param int $property_id Defines the `propertyId` of the Omni Layer token.
     *
     * @return self
     */
