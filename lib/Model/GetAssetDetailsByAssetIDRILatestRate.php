...
/**
 * GetAssetDetailsByAssetIDRILatestRate Class Doc Comment
 *
 * @category Class
 ...
 */
class GetAssetDetailsByAssetIDRILatestRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAssetDetailsByAssetIDRI_latestRate';
     ...
     * Sets amount
     *
     * @param string $amount Represents the amount of the latest rate.
     *
     * @return self
     */
     ...
     *
     * @param int|null $calculation_timestamp Defines when the price was calculated in UNIX timestamp. Oldest possible timestamp is 30 days.
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string $unit Specifies the unit of the latest price of the asset.
     *
     * @return self
     */
