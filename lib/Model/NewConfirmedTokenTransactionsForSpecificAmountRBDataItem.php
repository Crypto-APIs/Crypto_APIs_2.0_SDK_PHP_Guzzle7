...
/**
 * NewConfirmedTokenTransactionsForSpecificAmountRBDataItem Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class NewConfirmedTokenTransactionsForSpecificAmountRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewConfirmedTokenTransactionsForSpecificAmountRB_data_item';
     ...
     *
     * @param int $amount_higher_than Represents a specific amount of tokens after which the system have to send a callback to customers' callbackUrl.
     *
     * @return self
     */
