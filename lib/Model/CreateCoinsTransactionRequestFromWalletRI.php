...
class CreateCoinsTransactionRequestFromWalletRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fee_priority' => 'string',
        'note' => 'string',
        'recipients' => '\CryptoAPIs\Model\CreateCoinsTransactionRequestFromWalletRIRecipients[]',
     ...
     * Gets recipients
     *
     * @return \CryptoAPIs\Model\CreateCoinsTransactionRequestFromWalletRIRecipients[]
     */
     ...
     * Sets recipients
     *
     * @param \CryptoAPIs\Model\CreateCoinsTransactionRequestFromWalletRIRecipients[] $recipients Defines the destination of the transaction, whether it is incoming or outgoing.
     *
     * @return self
     */
