...
/**
 * NewUnconfirmedTokensTransactionsRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class NewUnconfirmedTokensTransactionsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewUnconfirmedTokensTransactionsRI';
     ...
     * Sets address
     *
     * @param string $address Defines the type of the specific event available for the customer to subscribe to for callback notification.
     *
     * @return self
     */
