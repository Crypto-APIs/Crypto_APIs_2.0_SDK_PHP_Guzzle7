...
/**
 * GetRawTransactionDataRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class GetRawTransactionDataRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetRawTransactionDataRI';
    ...
    {
        $this->container['transaction_hex'] = $data['transaction_hex'] ?? null;
    }
     ...
     *
     * @param string $transaction_hex Represents the raw transaction data in hexadecimal format.
     *
     * @return self
     */
