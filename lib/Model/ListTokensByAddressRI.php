...
/**
 * ListTokensByAddressRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListTokensByAddressRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTokensByAddressRI';
     ...
     *
     * @param string $confirmed_balance Defines the token balance that has been confirmed.
     *
     * @return self
     */
     ...
     * Sets symbol
     *
     * @param string $symbol Defines the token symbol by which the token contract is known. It is usually 3-4 characters in length.
     *
     * @return self
     */
