...
/**
 * DecodeRawTransactionHexRISB Class Doc Comment
 *
 * @category Class
 * @description Bitcoin
 * @package  CryptoAPIs
 ...
 */
class DecodeRawTransactionHexRISB implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DecodeRawTransactionHexRISB';
    ...
    protected static $openAPITypes = [
        ...
        'v_size' => 'int',
        'version' => 'int',
        'vin' => '\CryptoAPIs\Model\DecodeRawTransactionHexRISBVinInner[]',
        'vout' => '\CryptoAPIs\Model\DecodeRawTransactionHexRISBVoutInner[]',
        'weight' => 'int'
    ];
     ...
     * Gets vin
     *
     * @return \CryptoAPIs\Model\DecodeRawTransactionHexRISBVinInner[]
     */
     ...
     * Sets vin
     *
     * @param \CryptoAPIs\Model\DecodeRawTransactionHexRISBVinInner[] $vin Represents the transaction inputs.
     *
     * @return self
     */
     ...
     * Gets vout
     *
     * @return \CryptoAPIs\Model\DecodeRawTransactionHexRISBVoutInner[]
     */
     ...
     * Sets vout
     *
     * @param \CryptoAPIs\Model\DecodeRawTransactionHexRISBVoutInner[] $vout Represents the transaction outputs.
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param int|null $weight Represents the size of Bitcoin block, measured in weight units and including the segwit discount.
     *
     * @return self
     */
