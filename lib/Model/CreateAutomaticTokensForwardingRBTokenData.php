...
/**
 * CreateAutomaticTokensForwardingRBTokenData Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class CreateAutomaticTokensForwardingRBTokenData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAutomaticTokensForwardingRBTokenData';
     ...
     * Sets property_id
     *
     * @param int $property_id Represents the specific `propertyId` of the token data that will be forwarded.
     *
     * @return self
     */
     ...
     *
     * @param string $contract_address Represents the specific `contractAddress` of the Token that will be forwarded.
     *
     * @return self
     */
