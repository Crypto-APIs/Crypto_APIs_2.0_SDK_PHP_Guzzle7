...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'callback_url' => 'string',
        'note' => 'string',
        'recipient' => '\CryptoAPIs\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner[]',
     ...
     * Gets recipient
     *
     * @return \CryptoAPIs\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner[]
     */
     ...
     * Sets recipient
     *
     * @param \CryptoAPIs\Model\CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner[] $recipient Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
